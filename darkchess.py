...
def main():
    ...
    while True:
        ...
        #main_map[0][7] = (0, 7)
        #
        #ch = chess(14,0, 6, (cstart_x2+1*chess_back.get_width(),cstart_y2+0*chess_back.get_height()), (0, 5), chess_back.get_size(), index_to_chess_surface(14), index_to_chess_select(14))
        #ch.back = 0
        #ch.live = 1
        #main_chess[0][5] = ch
        #main_map[0][5] = (0, 5)
