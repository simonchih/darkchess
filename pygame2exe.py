...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "darkchess.py"
 
        #Name of program
        self.project_name = "Blind Chess"
 
        #Project url
        self.project_url = "http://sourceforge.net/projects/darkchess/"
        ...
        self.copyright = "Copyright (c) 2012 Me."
 
        #Description
        self.project_description = "MyApps Description"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "Image/darkchess_default.ico"
