...
def main():
    ...
    while True:
        ...
        ##main_map[2][7] = (2, 7)        
        #
        #ch = chess(29,1, 6, (cstart_x+2*chess_back.get_width(),cstart_y+2*chess_back.get_height()), (2, 2), chess_back.get_size(), index_to_chess_surface(29), index_to_chess_select(29))
        #ch.back = 0
        #ch.live = 1
        #main_chess[2][2] = ch
        #main_map[2][2] = (2, 2)        
