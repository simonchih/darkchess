#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe darkchess.py -W mysetup.py
...
darkchess = Target(
    ...
    script="darkchess.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'darkchess'
    # dest_base = "darkchess",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"darkchess.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="darkchess", level="asInvoker")).encode("utf-8")),
...
setup(name="name",
      ...
      windows=[ {
            "script": "darkchess.py",
            "icon_resources": [(1, "darkchess_default.ico")]
        }],
