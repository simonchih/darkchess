...
def move_score(org, dest, my_chess, a_map, owner_color):
    ...
    if a_map[desty][destx] == None:
        ...
        if my_chess[a_map[desty][destx][0]][a_map[desty][destx][1]].value == my_chess[a_map[orgy][orgx][0]][a_map[orgy][orgx][1]].value:
            return 2.5*eating_value_to_score(my_chess[a_map[desty][destx][0]][a_map[desty][destx][1]].value, king_live, my_chess[a_map[orgy][orgx][0]][a_map[orgy][orgx][1]].color)
        else:
...
def main():
    ...
    while True:
        ...
        #        main_map[i][j] = None        
        #
        #ch = chess(14,0, 6, (cstart_x+1*chess_back.get_width(),cstart_y+1*chess_back.get_height()), (1, 1), chess_back.get_size(), index_to_chess_surface(14), index_to_chess_select(14))
        #ch.back = 0
        #ch.live = 1
        #main_chess[1][1] = ch
        #main_map[1][1] = (1, 1)
        #
        #ch = chess(28,1, 5, (cstart_x+2*chess_back.get_width(),cstart_y+0*chess_back.get_height()), (0, 2), chess_back.get_size(), index_to_chess_surface(28), index_to_chess_select(28))
        #ch.back = 0
        #ch.live = 1
        #main_chess[0][2] = ch
        #main_map[0][2] = (0, 2)
        #
        #ch = chess(30,1, 6, (cstart_x+3*chess_back.get_width(),cstart_y+1*chess_back.get_height()), (1, 3), chess_back.get_size(), index_to_chess_surface(30), index_to_chess_select(30))
        #ch.back = 0
        #ch.live = 1
        #main_chess[1][3] = ch
        #main_map[1][3] = (1, 3)
        #
        #ch = chess(13,0, 6, (cstart_x+2*chess_back.get_width(),cstart_y+2*chess_back.get_height()), (2, 2), chess_back.get_size(), index_to_chess_surface(13), index_to_chess_select(13))
        #ch.back = 0
        #ch.live = 1
        #main_chess[2][2] = ch
        #main_map[2][2] = (2, 2)
        #
        #ch = chess(21,1, 2, (cstart_x+2*chess_back.get_width(),cstart_y+1*chess_back.get_height()), (1, 2), chess_back.get_size(), index_to_chess_surface(21), index_to_chess_select(21))
        #ch.back = 0
        #ch.live = 1
        #main_chess[1][2] = ch
        #main_map[1][2] = (1, 2)
